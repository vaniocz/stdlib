...
class EnumTest extends PHPUnit_Framework_TestCase
{
    ...
    function test_only_defined_values_can_be_instantiated()
    {
        ...
        $this->expectExceptionMessage('Enum Vanio\Language\Foo does not contain value named BOGUS.');
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('Value 123 is not within Vanio\Language\Foo enumeration.');
    ...
    function test_enum_values_cannot_be_deserialized()
    {
        ...
        unserialize('O:18:"Vanio\Language\Foo":1:{s:4:"name";s:3:"BAR"}');
    }
}
